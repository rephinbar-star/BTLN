...
- [x] Stage 1: Reconcile audit findings against current source and preview
- [x] Stage 2: Verify prior gates and finish authorized Group Read purchase behavior
...
- [ ] Unify the routed app shell: exact `BetweenTheLines` wordmark, compact navigation, remove every legacy shell logo, and verify representative routes (implementation complete; verification in progress)
