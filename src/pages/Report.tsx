          ...
          <div ref={reportRef}>
            ...
            <div data-pdf-exclude="true" className="mt-6 flex flex-col items-stretch gap-2 sm:flex-row sm:justify-center sm:gap-3">
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-full border border-border bg-card px-5 py-2.5 text-[14px] font-medium hover:bg-muted"
              >
                <Download className="h-4 w-4" /> {downloading ? "Preparing image…" : "Download Highlights"}
              </button>
              <button
                type="button"
            ...
            <div data-pdf-exclude="true" className="mt-14 flex flex-col items-center justify-center">
              <button
                ...
                className="rounded-full border border-[#4D5C3E]/30 bg-[#4D5C3E]/10 px-5 py-2.5 text-[14px] font-medium text-[#4D5C3E] shadow-md transition-colors hover:bg-[#4D5C3E] hover:text-white hover:border-[#4D5C3E]"
              >
                Give feedback
              </button>
